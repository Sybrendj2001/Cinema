                ...
                while (true)
                {
                    ...
                    if (CustomerTimeOption == "1")
                    {
                        ...
                        while (true)
                        {
                            ...
                            {
                                Tuple<Tuple<int, int, int, int, double, double, double>, List<Tuple<double, int, int, string, bool>>> hallseatInfo = Customer.Customer.hallSeatInfo(CustomerReserve, date);
